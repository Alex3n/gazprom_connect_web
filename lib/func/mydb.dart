...
/// Данный файл с глобальными методами предназначен для выполнения типичных
/// задач по работе c Firebase
...
void updateDoc(BuildContext context, Map<String, Object> data,
...
void deleteDoc(BuildContext context, String docPath, Map<String, Object> data,
    {whenDone()}) {
  showProgress(context);

...
import 'package:gazpromconnectweb/ui/pages/AdminProject.dart';
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          buildMyCardWithPadding(Text("Редактор идей"),
              ...
              context: context,
              margin: _margin),
          buildMyCardWithPadding(Text("Редактор проектов"),
              content: AdminContent.projects,
              padding: _padding,
              context: context,
              margin: _margin),
        ],

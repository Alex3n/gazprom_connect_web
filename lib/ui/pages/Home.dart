...
/// Данный класс отвечает за отображение страницы с идеями
...
class _HomeState extends State<Home> {
              ...
              builder: (BuildContext context,
                ...
                switch (snapshot.connectionState) {
                  ...
                  default:
                    ...
                    snapshot.data.docs
                        .forEach((doc) => result.putIfAbsent(doc.id, () {
                              if (doc.data()['like'] == null) {
                                return false;
                              } else
                                return List.from(doc.data()['like'])
                                    .contains(getUserId());
                            }));
  ...
  Widget buildSolutions(Map<String, bool> result, {DocumentSnapshot document}) {
  ...
  void _likeHandleTap(
      DocumentSnapshot document, Map<String, bool> result) async {
    setState(() {
